...
fft_signal[low_freq_count:len(fft_signal)//2]=0
fft_signal[len(fft_signal)//2:-low_freq_count]=0
...
for epoch in range(epochs):
    ...
    print(f"Epoch [{epoch+1}/{epochs}] - Train Loss: {total_loss/len(train_loader):.6f}, Validation Loss: {val_loss:.6f}")
